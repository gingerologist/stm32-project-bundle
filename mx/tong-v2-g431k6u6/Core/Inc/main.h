...
#define EN_POS_HV_Pin GPIO_PIN_0
#define EN_POS_HV_GPIO_Port GPIOB
#define MUX_SEL2_Pin GPIO_PIN_11
#define MUX_SEL2_GPIO_Port GPIOA
#define MUX_SEL3_Pin GPIO_PIN_12
#define MUX_SEL3_GPIO_Port GPIOA
#define CH0_SD_Pin GPIO_PIN_15
#define CH0_SD_GPIO_Port GPIOA
#define CH1_SD_Pin GPIO_PIN_3
#define CH1_SD_GPIO_Port GPIOB
#define MUX_EN_Pin GPIO_PIN_4
#define MUX_EN_GPIO_Port GPIOB
#define MUX_SEL4_Pin GPIO_PIN_5
